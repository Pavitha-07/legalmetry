/**
 * 3D hinge-fold heading text, ported near-verbatim from the reference
 * landing design (gsap + ScrollTrigger). Web-only raw DOM, see Scanner.tsx
...
const HINGE_CONFIG: Record<string, { origin: string; rotateX: number; rotateY: number }> = {
